...
class Topography(object):
    ...
    def plot(self, axes=None, contour_levels=None, contour_kwargs={}, 
        ...
        # Plot data
        import plottools ## FIX to import clawpack.visclaw.plottools eventually
        ...
        #x1 = self.extent[0] - self.delta[0]/2.
        #x2 = self.extent[1] + self.delta[0]/2.
        #y1 = self.extent[2] - self.delta[1]/2.
        #y2 = self.extent[3] + self.delta[1]/2.
