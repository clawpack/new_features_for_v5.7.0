...
# Eventually add new code from data_FlagRegions to amrclaw.data,
# for now import separately and use in setting flagregions below:
import sys
sys.path.insert(0,'../../new_python')
import data_FlagRegions
import region_tools # used to create ruled rectangle
