...
#------------------------------
    ...
    clawdata.lower[0] = -122.39 - arcsec16     # west longitude
    clawdata.upper[0] = -122.165 - arcsec16     # east longitude
    ...
    clawdata.bc_lower[0] = 'wall'  # so no flow at Chittenden Locks
    ...
    geo_data.sea_level = 3.1
        # Lake surface is 6.3m above MLLW,
        # which should be  3.1m above MHW
        # Seattle tide gauge datums:  MLLW=2.4, MHW=5.6
    ...
    topofiles.append([3, 1, 1, 0., 1e10, topodir + '/topo_1_3sec_LakeWA.tt3'])
